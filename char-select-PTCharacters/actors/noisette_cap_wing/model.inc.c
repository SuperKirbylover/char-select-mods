Lights1 noisette_cap_wing_CAP_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFF, 0xFF, 0xFF, 0x49, 0x49, 0x49);

Lights1 noisette_cap_wing_UNDERCAP_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFF, 0xFF, 0xFF, 0x49, 0x49, 0x49);

Lights1 noisette_cap_wing_Metal_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFF, 0xFF, 0xFF, 0x49, 0x49, 0x49);

Gfx noisette_cap_wing_Metal_Shade_rgba16_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 noisette_cap_wing_Metal_Shade_rgba16_rgba16[] = {
	#include "actors/noisette/Metal_Shade.rgba16.inc.c"
};

Gfx noisette_cap_wing_Metal_Light_rgba16_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 noisette_cap_wing_Metal_Light_rgba16_rgba16[] = {
	#include "actors/noisette/Metal_Light.rgba16.inc.c"
};

Gfx noisette_cap_wing_wing_2_ia8_aligner[] = {gsSPEndDisplayList()};
u8 noisette_cap_wing_wing_2_ia8[] = {
	#include "actors/noisette/wing_2.ia8.inc.c"
};

Gfx noisette_cap_wing_wing1_ia8_aligner[] = {gsSPEndDisplayList()};
u8 noisette_cap_wing_wing1_ia8[] = {
	#include "actors/noisette/wing1.ia8.inc.c"
};

Vtx noisette_cap_wing_Wing_Cap_mesh_layer_1_vtx_0[79] = {
...
Gfx noisette_cap_wing_Wing_Cap_mesh_layer_1_tri_0[] = {
	gsSPVertex(noisette_cap_wing_Wing_Cap_mesh_layer_1_vtx_0 + 0, 32, 0),
	...
	gsSPVertex(noisette_cap_wing_Wing_Cap_mesh_layer_1_vtx_0 + 32, 32, 0),
	...
	gsSPVertex(noisette_cap_wing_Wing_Cap_mesh_layer_1_vtx_0 + 64, 15, 0),
...
Vtx noisette_cap_wing_Wing_Cap_mesh_layer_1_vtx_1[8] = {
...
Gfx noisette_cap_wing_Wing_Cap_mesh_layer_1_tri_1[] = {
	gsSPVertex(noisette_cap_wing_Wing_Cap_mesh_layer_1_vtx_1 + 0, 8, 0),
...
Vtx noisette_cap_wing_Wings_mesh_layer_4_vtx_0[8] = {
...
Gfx noisette_cap_wing_Wings_mesh_layer_4_tri_0[] = {
	gsSPVertex(noisette_cap_wing_Wings_mesh_layer_4_vtx_0 + 0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
	gsSPEndDisplayList(),
};

Vtx noisette_cap_wing_Wings_mesh_layer_4_vtx_1[8] = {
...
Gfx noisette_cap_wing_Wings_mesh_layer_4_tri_1[] = {
	gsSPVertex(noisette_cap_wing_Wings_mesh_layer_4_vtx_1 + 0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Gfx mat_noisette_cap_wing_UNDERCAP[] = {
	gsSPCopyLightsPlayerPart(CAP),
	gsDPPipeSync(),
...
Gfx mat_noisette_cap_wing_Metal[] = {
	gsSPGeometryMode(0, G_TEXTURE_GEN),
	gsSPCopyLightsPlayerPart(CAP),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, TEXEL1, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, TEXEL1, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(4032, 1984, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, noisette_cap_wing_Metal_Shade_rgba16_rgba16),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0),
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, noisette_cap_wing_Metal_Light_rgba16_rgba16),
...
Gfx mat_revert_noisette_cap_wing_Metal[] = {
	gsSPGeometryMode(G_TEXTURE_GEN, 0),
	gsDPPipeSync(),
	gsSPEndDisplayList(),
};

Gfx mat_noisette_cap_wing_Wing_Tip[] = {
	gsSPGeometryMode(G_CULL_BACK, 0),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, TEXEL0, TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, TEXEL0, TEXEL0, 0, ENVIRONMENT, 0),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b_LOAD_BLOCK, 1, noisette_cap_wing_wing_2_ia8),
...
Gfx mat_revert_noisette_cap_wing_Wing_Tip[] = {
	gsSPGeometryMode(0, G_CULL_BACK),
	gsDPPipeSync(),
	gsSPEndDisplayList(),
};

Gfx mat_noisette_cap_wing_Wing_Base[] = {
	gsSPGeometryMode(G_CULL_BACK, 0),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, TEXEL0, TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, TEXEL0, TEXEL0, 0, ENVIRONMENT, 0),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b_LOAD_BLOCK, 1, noisette_cap_wing_wing1_ia8),
	gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_8b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 1023, 512),
	gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_8b, 4, 0, 0, 0, G_TX_CLAMP | G_TX_NOMIRROR, 6, 0, G_TX_CLAMP | G_TX_NOMIRROR, 5, 0),
	gsDPSetTileSize(0, 0, 0, 124, 252),
...
Gfx mat_revert_noisette_cap_wing_Wing_Base[] = {
	gsSPGeometryMode(0, G_CULL_BACK),
	gsDPPipeSync(),
	gsSPEndDisplayList(),
};

Gfx noisette_cap_wing_Wing_Cap_mesh_layer_1[] = {
	gsSPDisplayList(mat_noisette_cap_wing_CAP),
	gsSPDisplayList(noisette_cap_wing_Wing_Cap_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_noisette_cap_wing_UNDERCAP),
	gsSPDisplayList(noisette_cap_wing_Wing_Cap_mesh_layer_1_tri_1),
	gsDPPipeSync(),
...
Gfx noisette_cap_wing_Wing_Cap_mesh_layer_1_mat_override_Metal_0[] = {
	gsSPDisplayList(mat_noisette_cap_wing_Metal),
	gsSPDisplayList(noisette_cap_wing_Wing_Cap_mesh_layer_1_tri_0),
	gsSPDisplayList(noisette_cap_wing_Wing_Cap_mesh_layer_1_tri_1),
	gsSPDisplayList(mat_revert_noisette_cap_wing_Metal),
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_LIGHTING),
	gsSPClearGeometryMode(G_TEXTURE_GEN),
	gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT, 0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT),
...
Gfx noisette_cap_wing_Wings_mesh_layer_4[] = {
	gsSPDisplayList(mat_noisette_cap_wing_Wing_Tip),
	gsSPDisplayList(noisette_cap_wing_Wings_mesh_layer_4_tri_0),
	gsSPDisplayList(mat_revert_noisette_cap_wing_Wing_Tip),
	gsSPDisplayList(mat_noisette_cap_wing_Wing_Base),
	gsSPDisplayList(noisette_cap_wing_Wings_mesh_layer_4_tri_1),
	gsSPDisplayList(mat_revert_noisette_cap_wing_Wing_Base),
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_LIGHTING),
	gsSPClearGeometryMode(G_TEXTURE_GEN),
	gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT, 0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT),
...
Gfx noisette_cap_wing_Wings_mesh_layer_4_mat_override_Metal_0[] = {
	gsSPDisplayList(mat_noisette_cap_wing_Metal),
	gsSPDisplayList(noisette_cap_wing_Wings_mesh_layer_4_tri_0),
	gsSPDisplayList(noisette_cap_wing_Wings_mesh_layer_4_tri_1),
	gsSPDisplayList(mat_revert_noisette_cap_wing_Metal),
