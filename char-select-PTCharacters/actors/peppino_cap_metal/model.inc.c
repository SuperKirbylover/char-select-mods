Lights1 peppino_cap_metal_metal_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0x0, 0x0, 0x0, 0x49, 0x49, 0x49);

Gfx peppino_cap_metal_Metal_Shade_rgba16_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 peppino_cap_metal_Metal_Shade_rgba16_rgba16[] = {
	#include "actors/peppino/Metal_Shade.rgba16.inc.c"
};

Gfx peppino_cap_metal_Metal_Light_rgba16_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 peppino_cap_metal_Metal_Light_rgba16_rgba16[] = {
	#include "actors/peppino/Metal_Light.rgba16.inc.c"
};

Vtx peppino_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0[63] = {
	{{ {70, 40, -62}, 0, {755, -191}, {70, 171, 194, 255} }},
	{{ {69, 0, -60}, 0, {1036, -191}, {75, 175, 193, 255} }},
	{{ {0, 0, -92}, 0, {917, -517}, {0, 174, 159, 255} }},
	{{ {86, 40, 3}, 0, {785, 32}, {94, 172, 10, 255} }},
	{{ {125, 51, 3}, 0, {568, 32}, {82, 159, 7, 255} }},
	{{ {93, 51, -81}, 0, {536, -191}, {63, 163, 196, 255} }},
	{{ {0, 51, -120}, 0, {393, -517}, {0, 164, 168, 255} }},
	{{ {0, 40, -93}, 0, {626, -517}, {0, 176, 158, 255} }},
	{{ {-70, 40, -62}, 0, {755, -191}, {186, 171, 194, 255} }},
	{{ {-69, 0, -60}, 0, {1036, -191}, {181, 175, 193, 255} }},
	{{ {-86, 0, 3}, 0, {1059, 32}, {158, 175, 7, 255} }},
	{{ {86, 0, 3}, 0, {1059, 32}, {98, 175, 7, 255} }},
	{{ {59, 40, 61}, 0, {697, 238}, {70, 178, 72, 255} }},
	{{ {79, 51, 87}, 0, {470, 238}, {53, 155, 56, 255} }},
	{{ {138, 71, 4}, 0, {402, 33}, {124, 25, 7, 255} }},
	{{ {101, 71, -91}, 0, {392, -188}, {90, 23, 170, 255} }},
	{{ {0, 71, -132}, 0, {183, -507}, {0, 16, 130, 255} }},
	{{ {-101, 71, -91}, 0, {392, -188}, {166, 23, 170, 255} }},
	{{ {-93, 51, -81}, 0, {536, -191}, {193, 163, 196, 255} }},
	{{ {-125, 51, 3}, 0, {568, 32}, {174, 159, 7, 255} }},
	{{ {-86, 40, 3}, 0, {785, 32}, {162, 172, 10, 255} }},
	{{ {-59, 40, 61}, 0, {697, 238}, {186, 178, 72, 255} }},
	{{ {-64, 0, 63}, 0, {999, 238}, {182, 183, 73, 255} }},
	{{ {0, 0, 86}, 0, {842, 484}, {0, 177, 99, 255} }},
	{{ {64, 0, 63}, 0, {999, 238}, {74, 183, 73, 255} }},
	{{ {0, 40, 85}, 0, {592, 484}, {0, 176, 99, 255} }},
	{{ {0, 51, 114}, 0, {345, 484}, {0, 156, 78, 255} }},
	{{ {87, 71, 102}, 0, {300, 222}, {81, 16, 97, 255} }},
	...
	{{ {-79, 86, -80}, 0, {228, -177}, {224, 117, 218, 255} }},
	{{ {-138, 71, 4}, 0, {402, 33}, {132, 25, 7, 255} }},
	{{ {-93, 51, -81}, 0, {536, -191}, {193, 163, 196, 255} }},
	{{ {-125, 51, 3}, 0, {568, 32}, {174, 159, 7, 255} }},
	...
	{{ {-64, 0, 63}, 0, {999, 238}, {182, 183, 73, 255} }},
	{{ {0, 51, 114}, 0, {345, 484}, {0, 156, 78, 255} }},
	{{ {-87, 71, 102}, 0, {300, 222}, {175, 16, 97, 255} }},
	{{ {0, 71, 131}, 0, {112, 473}, {0, 12, 126, 255} }},
	{{ {87, 71, 102}, 0, {300, 222}, {81, 16, 97, 255} }},
...
Gfx peppino_cap_metal_Metal_Cap_DL_mesh_layer_1_tri_0[] = {
	gsSPVertex(peppino_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0 + 0, 32, 0),
	...
	gsSPVertex(peppino_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0 + 32, 31, 0),
...
Gfx mat_peppino_cap_metal_metal[] = {
	gsSPGeometryMode(0, G_TEXTURE_GEN),
	gsSPCopyLightsPlayerPart(CAP),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, TEXEL1, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, TEXEL1, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(4032, 1984, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, peppino_cap_metal_Metal_Shade_rgba16_rgba16),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0),
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, peppino_cap_metal_Metal_Light_rgba16_rgba16),
...
Gfx mat_revert_peppino_cap_metal_metal[] = {
	gsSPGeometryMode(G_TEXTURE_GEN, 0),
	gsDPPipeSync(),
	gsSPEndDisplayList(),
};

Gfx peppino_cap_metal_Metal_Cap_DL_mesh_layer_1[] = {
	gsSPDisplayList(mat_peppino_cap_metal_metal),
	gsSPDisplayList(peppino_cap_metal_Metal_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_peppino_cap_metal_metal),
	gsDPPipeSync(),
...
Gfx peppino_cap_metal_Metal_Cap_DL_mesh_layer_1_mat_override_metal_0[] = {
	gsSPDisplayList(mat_peppino_cap_metal_metal),
	gsSPDisplayList(peppino_cap_metal_Metal_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_peppino_cap_metal_metal),
	gsDPPipeSync(),
