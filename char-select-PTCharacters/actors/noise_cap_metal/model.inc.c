Lights1 noise_cap_metal_Metal_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0x0, 0x0, 0x0, 0x28, 0x28, 0x28);

Gfx noise_cap_metal_Metal_Shade_rgba16_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 noise_cap_metal_Metal_Shade_rgba16_rgba16[] = {
	#include "actors/noise/Metal_Shade.rgba16.inc.c"
};

Gfx noise_cap_metal_Metal_Light_rgba16_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 noise_cap_metal_Metal_Light_rgba16_rgba16[] = {
	#include "actors/noise/Metal_Light.rgba16.inc.c"
};

Vtx noise_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0[123] = {
	...
	{{ {-51, 81, 42}, 0, {1257, 93}, {2, 127, 254, 255} }},
	{{ {0, 81, 61}, 0, {1630, 239}, {0, 127, 252, 255} }},
	{{ {0, 72, -2}, 0, {1760, -29}, {0, 127, 1, 255} }},
	{{ {-65, 81, -3}, 0, {1242, -36}, {5, 127, 0, 255} }},
	{{ {-51, 81, -44}, 0, {1288, -153}, {2, 127, 2, 255} }},
	{{ {0, 81, -59}, 0, {1698, -274}, {0, 127, 5, 255} }},
	...
	{{ {91, 67, -91}, 0, {848, -227}, {79, 34, 163, 255} }},
	{{ {0, 80, -93}, 0, {1498, -388}, {0, 122, 222, 255} }},
	{{ {51, 81, -44}, 0, {1288, -153}, {254, 127, 2, 255} }},
	{{ {0, 81, -59}, 0, {1698, -274}, {0, 127, 5, 255} }},
	{{ {0, 72, -2}, 0, {1760, -29}, {0, 127, 1, 255} }},
	{{ {65, 81, -3}, 0, {1242, -36}, {251, 127, 0, 255} }},
	{{ {51, 81, 42}, 0, {1257, 93}, {254, 127, 254, 255} }},
	{{ {0, 81, 61}, 0, {1630, 239}, {0, 127, 252, 255} }},
	{{ {0, 80, 93}, 0, {1418, 344}, {0, 123, 32, 255} }},
...
Gfx noise_cap_metal_Metal_Cap_DL_mesh_layer_1_tri_0[] = {
	gsSPVertex(noise_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0 + 0, 32, 0),
	...
	gsSPVertex(noise_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0 + 32, 32, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
	...
	gsSPVertex(noise_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0 + 64, 32, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
	...
	gsSPVertex(noise_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0 + 96, 27, 0),
...
Gfx mat_noise_cap_metal_Metal[] = {
	gsSPGeometryMode(0, G_TEXTURE_GEN),
	gsSPCopyLightsPlayerPart(CAP),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, TEXEL1, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, TEXEL1, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(4032, 1984, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, noise_cap_metal_Metal_Shade_rgba16_rgba16),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0),
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, noise_cap_metal_Metal_Light_rgba16_rgba16),
...
Gfx mat_revert_noise_cap_metal_Metal[] = {
	gsSPGeometryMode(G_TEXTURE_GEN, 0),
	gsDPPipeSync(),
	gsSPEndDisplayList(),
};

Gfx noise_cap_metal_Metal_Cap_DL_mesh_layer_1[] = {
	gsSPDisplayList(mat_noise_cap_metal_Metal),
	gsSPDisplayList(noise_cap_metal_Metal_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_noise_cap_metal_Metal),
	gsDPPipeSync(),
...
Gfx noise_cap_metal_Metal_Cap_DL_mesh_layer_1_mat_override_Metal_0[] = {
	gsSPDisplayList(mat_noise_cap_metal_Metal),
	gsSPDisplayList(noise_cap_metal_Metal_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_noise_cap_metal_Metal),
	gsDPPipeSync(),
