Lights1 papyrus_cap_metal_Metal__METAL__lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFF, 0xFF, 0xFF, 0x49, 0x49, 0x49);

Gfx papyrus_cap_metal_Metal_Shade_rgba16_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 papyrus_cap_metal_Metal_Shade_rgba16_rgba16[] = {
	#include "actors/papyrus/Metal_Shade.rgba16.inc.c"
};

Gfx papyrus_cap_metal_Metal_Light_rgba16_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 papyrus_cap_metal_Metal_Light_rgba16_rgba16[] = {
	#include "actors/papyrus/Metal_Light.rgba16.inc.c"
};

Vtx papyrus_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0[43] = {
	{{ {0, 20, -138}, 0, {1788, -17}, {0, 125, 235, 255} }},
	{{ {-82, 38, -75}, 0, {1532, -529}, {244, 124, 234, 255} }},
	{{ {0, 32, -106}, 0, {1788, -529}, {0, 125, 234, 255} }},
	{{ {-127, 19, -95}, 0, {1532, -17}, {161, 82, 236, 255} }},
	{{ {-137, 15, -262}, 0, {1532, -17}, {175, 75, 193, 255} }},
	{{ {0, 16, -277}, 0, {1788, -17}, {0, 91, 167, 255} }},
	{{ {137, 15, -262}, 0, {1532, -17}, {81, 75, 193, 255} }},
	{{ {127, 19, -95}, 0, {1532, -17}, {95, 82, 236, 255} }},
	{{ {82, 38, -75}, 0, {1532, -529}, {12, 124, 234, 255} }},
	{{ {106, 41, -1}, 0, {1276, -529}, {12, 126, 4, 255} }},
	...
	{{ {0, 3, -130}, 0, {1788, -17}, {0, 129, 1, 255} }},
	{{ {0, 0, 107}, 0, {1020, -17}, {0, 129, 7, 255} }},
	...
	{{ {-106, 41, -1}, 0, {743, 239}, {244, 126, 4, 255} }},
	{{ {-77, 29, 4}, 0, {599, 239}, {32, 123, 253, 255} }},
	{{ {-82, 38, -75}, 0, {599, 66}, {244, 124, 234, 255} }},
	...
	{{ {106, 41, -1}, 0, {743, 239}, {12, 126, 4, 255} }},
	{{ {82, 38, -75}, 0, {599, 66}, {12, 124, 234, 255} }},
	{{ {0, 32, -106}, 0, {252, -6}, {0, 125, 234, 255} }},
};

Gfx papyrus_cap_metal_Metal_Cap_DL_mesh_layer_1_tri_0[] = {
	gsSPVertex(papyrus_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0 + 0, 32, 0),
	...
	gsSPVertex(papyrus_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0 + 32, 11, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
...
Gfx mat_papyrus_cap_metal_Metal__METAL_[] = {
	gsSPGeometryMode(0, G_TEXTURE_GEN),
	gsSPCopyLightsPlayerPart(CAP),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, TEXEL1, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, TEXEL1, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(4032, 1984, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, papyrus_cap_metal_Metal_Shade_rgba16_rgba16),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0),
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, papyrus_cap_metal_Metal_Light_rgba16_rgba16),
...
Gfx mat_revert_papyrus_cap_metal_Metal__METAL_[] = {
	gsSPGeometryMode(G_TEXTURE_GEN, 0),
	gsDPPipeSync(),
	gsSPEndDisplayList(),
};

Gfx papyrus_cap_metal_Metal_Cap_DL_mesh_layer_1[] = {
	gsSPDisplayList(mat_papyrus_cap_metal_Metal__METAL_),
	gsSPDisplayList(papyrus_cap_metal_Metal_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_papyrus_cap_metal_Metal__METAL_),
	gsDPPipeSync(),
...
Gfx papyrus_cap_metal_Metal_Cap_DL_mesh_layer_1_mat_override_Metal__METAL__0[] = {
	gsSPDisplayList(mat_papyrus_cap_metal_Metal__METAL_),
	gsSPDisplayList(papyrus_cap_metal_Metal_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_papyrus_cap_metal_Metal__METAL_),
	gsDPPipeSync(),
