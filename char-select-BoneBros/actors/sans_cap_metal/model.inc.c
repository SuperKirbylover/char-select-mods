Lights1 sans_cap_metal_Metal__METAL__lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFF, 0xFF, 0xFF, 0x49, 0x49, 0x49);

Gfx sans_cap_metal_Metal_Shade_rgba16_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 sans_cap_metal_Metal_Shade_rgba16_rgba16[] = {
	#include "actors/sans/Metal_Shade.rgba16.inc.c"
};

Gfx sans_cap_metal_Metal_Light_rgba16_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 sans_cap_metal_Metal_Light_rgba16_rgba16[] = {
	#include "actors/sans/Metal_Light.rgba16.inc.c"
};

Vtx sans_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0[154] = {
	{{ {103, 2, -2}, 0, {150, -529}, {11, 133, 31, 255} }},
	...
	{{ {-34, 50, -42}, 0, {864, -385}, {83, 96, 250, 255} }},
	...
	{{ {103, 2, -2}, 0, {150, -17}, {11, 133, 31, 255} }},
	...
	{{ {138, 26, 100}, 0, {559, -17}, {219, 77, 94, 255} }},
	{{ {149, 2, 95}, 0, {559, -17}, {254, 163, 86, 255} }},
	{{ {139, 26, 94}, 0, {559, -93}, {217, 121, 7, 255} }},
	{{ {170, 26, 96}, 0, {969, -17}, {44, 73, 94, 255} }},
	...
	{{ {106, 0, 119}, 0, {1203, -17}, {81, 204, 83, 255} }},
	{{ {92, 21, 109}, 0, {1203, -17}, {221, 35, 117, 255} }},
	{{ {31, 17, 112}, 0, {1033, -17}, {160, 234, 81, 255} }},
	{{ {32, 33, 116}, 0, {864, -17}, {184, 58, 88, 255} }},
	{{ {91, 41, -6}, 0, {1033, -17}, {44, 114, 35, 255} }},
	{{ {34, 50, -42}, 0, {864, -275}, {173, 96, 250, 255} }},
	...
	{{ {85, 2, -50}, 0, {1495, -203}, {8, 129, 0, 255} }},
	{{ {103, 2, -2}, 0, {1495, -17}, {11, 133, 31, 255} }},
	{{ {106, 0, 119}, 0, {1495, -17}, {81, 204, 83, 255} }},
	{{ {-91, 41, -6}, 0, {559, -529}, {212, 114, 35, 255} }},
	{{ {-103, 2, -2}, 0, {150, -17}, {245, 133, 31, 255} }},
	...
	{{ {-170, 26, 96}, 0, {969, -17}, {212, 73, 94, 255} }},
	{{ {-185, 12, 88}, 0, {1378, -17}, {170, 200, 75, 255} }},
	...
	{{ {-172, 26, 90}, 0, {969, -93}, {210, 118, 10, 255} }},
	{{ {-139, 26, 94}, 0, {559, -93}, {39, 121, 7, 255} }},
	{{ {-138, 26, 100}, 0, {559, -17}, {37, 77, 94, 255} }},
	...
	{{ {-92, 21, 109}, 0, {1203, -17}, {35, 35, 117, 255} }},
	{{ {-31, 17, 112}, 0, {1033, -17}, {96, 234, 81, 255} }},
	{{ {-32, 33, 116}, 0, {864, -17}, {72, 58, 88, 255} }},
	{{ {-91, 41, -6}, 0, {1033, -17}, {212, 114, 35, 255} }},
	{{ {-34, 50, -42}, 0, {864, -275}, {83, 96, 250, 255} }},
	{{ {-108, 49, -85}, 0, {1033, -340}, {212, 112, 215, 255} }},
	{{ {-53, 47, -86}, 0, {864, -375}, {25, 121, 225, 255} }},
	{{ {-31, 17, 112}, 0, {859, -17}, {96, 234, 81, 255} }},
	{{ {-34, 50, -42}, 0, {864, -385}, {83, 96, 250, 255} }},
	{{ {-33, 34, -54}, 0, {859, -375}, {119, 31, 224, 255} }},
};

Gfx sans_cap_metal_Metal_Cap_DL_mesh_layer_1_tri_0[] = {
	gsSPVertex(sans_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0 + 0, 32, 0),
	...
	gsSPVertex(sans_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0 + 32, 32, 0),
	...
	gsSPVertex(sans_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0 + 64, 32, 0),
	...
	gsSPVertex(sans_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0 + 96, 32, 0),
	...
	gsSPVertex(sans_cap_metal_Metal_Cap_DL_mesh_layer_1_vtx_0 + 128, 26, 0),
...
Gfx mat_sans_cap_metal_Metal__METAL_[] = {
	gsSPGeometryMode(0, G_TEXTURE_GEN),
	gsSPCopyLightsPlayerPart(CAP),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, TEXEL1, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, TEXEL1, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(4032, 1984, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, sans_cap_metal_Metal_Shade_rgba16_rgba16),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0),
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, sans_cap_metal_Metal_Light_rgba16_rgba16),
...
Gfx mat_revert_sans_cap_metal_Metal__METAL_[] = {
	gsSPGeometryMode(G_TEXTURE_GEN, 0),
	gsDPPipeSync(),
	gsSPEndDisplayList(),
};

Gfx sans_cap_metal_Metal_Cap_DL_mesh_layer_1[] = {
	gsSPDisplayList(mat_sans_cap_metal_Metal__METAL_),
	gsSPDisplayList(sans_cap_metal_Metal_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_sans_cap_metal_Metal__METAL_),
	gsDPPipeSync(),
...
Gfx sans_cap_metal_Metal_Cap_DL_mesh_layer_1_mat_override_Metal__METAL__0[] = {
	gsSPDisplayList(mat_sans_cap_metal_Metal__METAL_),
	gsSPDisplayList(sans_cap_metal_Metal_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_sans_cap_metal_Metal__METAL_),
	gsDPPipeSync(),
